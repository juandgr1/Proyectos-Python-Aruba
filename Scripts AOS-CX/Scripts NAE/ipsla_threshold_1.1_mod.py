...
ParameterDefinitions = {
    ...
    'traceroute_ip': {
        'Name': 'Traceroute IP Address',
        'Description': 'The Traceroute IP Address that will be tested against as\n'
                       'an alert action.',
        'Type': 'string',
        'Default': '192.168.1.1'
    },
    'traceroute_vrf': {
        'Name': 'Traceroute VRF',
        'Description': 'The VRF which the Traceroute command will run on as\n'
                       'an alert action.',
        'Type': 'string',
        'Default': 'default'
        }
...
class Agent(NAE):
    ...
    def default_actions(self):
        ...
        ActionCLI('traceroute ' + self.params['traceroute_ip'].value + ' vrf ' + self.params['traceroute_vrf'].value + '\n')
